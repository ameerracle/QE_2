# Recovered from IPython history - session cell ending line 152760
from pathlib import Path
import matplotlib.image as mpimg
import matplotlib.pyplot as plt

# > Figure 2: PDOS Li2S4 comparison plots (all metals)
base_dir = Path('/home/ameer_ubuntu/Git_projects/QE_2/Final_plots/PDOS_Plots/comparison')
out_file = Path('/home/ameer_ubuntu/Git_projects/QE_2/Final_plots/Figure_2_PDOS_subplot.png')

metal_order = ['Sc', 'Ti', 'V', 'V_U', 'Nb', 'Zr']

plot_files = [base_dir / f'{m}_Li2S4_comparison.png' for m in metal_order]
