# Recovered from IPython history - session cell ending line 152800
from pathlib import Path
import matplotlib.image as mpimg
import matplotlib.pyplot as plt

# > Figure S2: PDOS Li2S8 comparison plots (all metals) ? Supplemental
base_dir = Path('/home/ameer_ubuntu/Git_projects/QE_2/Final_plots/PDOS_Plots/comparison')
out_file = Path('/home/ameer_ubuntu/Git_projects/QE_2/Final_plots/Figure_S2_PDOS_Li2S8.png')

metal_order = ['Sc', 'Ti', 'V', 'V_U', 'Nb', 'Zr']

plot_files = [base_dir / f'{m}_Li2S8_comparison.png' for m in metal_order]
