...
REMOTE_DIR="/lustre10/scratch/anizami/QE_2/no_u/combi_144"
LOCAL_DIR="/home/ameer_ubuntu/Git_projects/QE_2/no_u/combi_144"
...
rsync "${RSYNC_OPTS[@]}" \
    --include='*_combi_relax/' \
    --include='*_combi_relax/*.out' \
    --exclude='*/' \
    --exclude='*' \
