#!/usr/bin/env python3
"""
Relax one or more .xyz structures in this folder using Quantum ESPRESSO (pw.x).
...
Run:
	python LiS_relax.py --xyz NbN_LiS_combi2_144.xyz
...
def main():
	parser = argparse.ArgumentParser(
		description="Relax one or more .xyz structures in no_u/NEB_Li2S."
	)
	parser.add_argument(
		"--dry-run",
		action="store_true",
